...
//					#define INT_GAUGE (((PIN_REGISTER_INT_GAUGE) >> (PIN_INT_GAUGE)) & 0x01)
			...
			public:
				...
				// Module PCINT0 Interrupt Function [PCINT0]
				inline void PCINT0_Interrupt(bool _Status = false) {

					// Read PCMSK0
					uint8_t _PCMSK0 = PCMSK0;
				...
				// Module PCINT1 Interrupt Function [PCINT1]
				inline void PCINT1_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT1 Bit on PCMSK0
						_PCMSK0 |= (1 << PCINT1);

					} else {

						// Clear PCINT1 Bit on PCMSK0
						_PCMSK0 &= ~(1 << PCINT1);
				...
				// Module PCINT2 Interrupt Function [PCINT2]
				inline void PCINT2_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT2 Bit on PCMSK0
						_PCMSK0 |= (1 << PCINT2);

					} else {

						// Clear PCINT2 Bit on PCMSK0
						_PCMSK0 &= ~(1 << PCINT2);
				...
				// Module PCINT3 Interrupt Function [PCINT3]
				inline void PCINT3_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT3 Bit on PCMSK0
						_PCMSK0 |= (1 << PCINT3);

					} else {

						// Clear PCINT3 Bit on PCMSK0
						_PCMSK0 &= ~(1 << PCINT3);
				...
				// Module PCINT4 Interrupt Function [PCINT4]
				inline void PCINT4_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT4 Bit on PCMSK0
						_PCMSK0 |= (1 << PCINT4);

					} else {

						// Clear PCINT4 Bit on PCMSK0
						_PCMSK0 &= ~(1 << PCINT4);
				...
				// Module PCINT5 Interrupt Function [PCINT5]
				inline void PCINT5_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT5 Bit on PCMSK0
						_PCMSK0 |= (1 << PCINT5);

					} else {

						// Clear PCINT5 Bit on PCMSK0
						_PCMSK0 &= ~(1 << PCINT5);
				...
				// Module PCINT6 Interrupt Function [PCINT6]
				inline void PCINT6_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT6 Bit on PCMSK0
						_PCMSK0 |= (1 << PCINT6);

					} else {

						// Clear PCINT6 Bit on PCMSK0
						_PCMSK0 &= ~(1 << PCINT6);
				...
				// Module PCINT7 Interrupt Function [PCINT7]
				inline void PCINT7_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT7 Bit on PCMSK0
						_PCMSK0 |= (1 << PCINT7);

					} else {

						// Clear PCINT7 Bit on PCMSK0
						_PCMSK0 &= ~(1 << PCINT7);
				...
				// Module PCINT8 Interrupt Function [PCINT8]
				inline void PCINT8_Interrupt(bool _Status = false) {

					// Read PCMSK1
					uint8_t _PCMSK1 = PCMSK1;

					// Control for Status
					if (_Status) {

						// Set PCINT8 Bit on PCMSK1
						_PCMSK1 |= (1 << PCINT8);

					} else {

						// Clear PCINT8 Bit on PCMSK1
						_PCMSK1 &= ~(1 << PCINT8);
				...
				// Module PCINT9 Interrupt Function [PCINT9]
				inline void PCINT9_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT9 Bit on PCMSK1
						_PCMSK1 |= (1 << PCINT9);

					} else {

						// Clear PCINT9 Bit on PCMSK1
						_PCMSK1 &= ~(1 << PCINT9);
				...
				// Module PCINT10 Interrupt Function [PCINT10]
				inline void PCINT10_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT10 Bit on PCMSK1
						_PCMSK1 |= (1 << PCINT10);

					} else {

						// Clear PCINT10 Bit on PCMSK1
						_PCMSK1 &= ~(1 << PCINT10);
				...
				// Module PCINT11 Interrupt Function [PCINT11]
				inline void PCINT11_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT11 Bit on PCMSK1
						_PCMSK1 |= (1 << PCINT11);

					} else {

						// Clear PCINT11 Bit on PCMSK1
						_PCMSK1 &= ~(1 << PCINT11);
				...
				// Module PCINT12 Interrupt Function [PCINT12]
				inline void PCINT12_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT12 Bit on PCMSK1
						_PCMSK1 |= (1 << PCINT12);

					} else {

						// Clear PCINT12 Bit on PCMSK1
						_PCMSK1 &= ~(1 << PCINT12);
				...
				// Module PCINT13 Interrupt Function [PCINT13]
				inline void PCINT13_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT13 Bit on PCMSK1
						_PCMSK1 |= (1 << PCINT13);

					} else {

						// Clear PCINT13 Bit on PCMSK1
						_PCMSK1 &= ~(1 << PCINT13);
				...
				// Module PCINT14 Interrupt Function [PCINT14]
				inline void PCINT14_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT14 Bit on PCMSK1
						_PCMSK1 |= (1 << PCINT14);

					} else {

						// Clear PCINT14 Bit on PCMSK1
						_PCMSK1 &= ~(1 << PCINT14);
				...
				// Module PCINT15 Interrupt Function [PCINT15]
				inline void PCINT15_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT15 Bit on PCMSK1
						_PCMSK1 |= (1 << PCINT15);

					} else {

						// Clear PCINT15 Bit on PCMSK1
						_PCMSK1 &= ~(1 << PCINT15);
				...
				// Module PCINT16 Interrupt Function [PCINT16]
				inline void PCINT16_Interrupt(bool _Status = false) {

					// Read PCMSK2
					uint8_t _PCMSK2 = PCMSK2;

					// Control for Status
					if (_Status) {

						// Set PCINT16 Bit on PCMSK2
						_PCMSK2 |= (1 << PCINT16);

					} else {

						// Clear PCINT16 Bit on PCMSK2
						_PCMSK2 &= ~(1 << PCINT16);
				...
				// Module PCINT17 Interrupt Function [PCINT17]
				inline void PCINT17_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT17 Bit on PCMSK2
						_PCMSK2 |= (1 << PCINT17);

					} else {

						// Clear PCINT17 Bit on PCMSK2
						_PCMSK2 &= ~(1 << PCINT17);
				...
				// Module PCINT18 Interrupt Function [PCINT18]
				inline void PCINT18_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT18 Bit on PCMSK2
						_PCMSK2 |= (1 << PCINT18);

					} else {

						// Clear PCINT18 Bit on PCMSK2
						_PCMSK2 &= ~(1 << PCINT18);
				...
				// Module PCINT19 Interrupt Function [PCINT19]
				inline void PCINT19_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT19 Bit on PCMSK2
						_PCMSK2 |= (1 << PCINT19);

					} else {

						// Clear PCINT19 Bit on PCMSK2
						_PCMSK2 &= ~(1 << PCINT19);
				...
				// Module PCINT20 Interrupt Function [PCINT20]
				inline void PCINT20_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT20 Bit on PCMSK2
						_PCMSK2 |= (1 << PCINT20);

					} else {

						// Clear PCINT20 Bit on PCMSK2
						_PCMSK2 &= ~(1 << PCINT20);
				...
				// Module PCINT21 Interrupt Function [PCINT21]
				inline void PCINT21_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT21 Bit on PCMSK2
						_PCMSK2 |= (1 << PCINT21);

					} else {

						// Clear PCINT21 Bit on PCMSK2
						_PCMSK2 &= ~(1 << PCINT21);
				...
				// Module PCINT22 Interrupt Function [PCINT22]
				inline void PCINT22_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT22 Bit on PCMSK2
						_PCMSK2 |= (1 << PCINT22);

					} else {

						// Clear PCINT22 Bit on PCMSK2
						_PCMSK2 &= ~(1 << PCINT22);
				...
				// Module PCINT23 Interrupt Function [PCINT23]
				inline void PCINT23_Interrupt(bool _Status = false) {
					...
					if (_Status) {
						...
						// Set PCINT23 Bit on PCMSK2
						_PCMSK2 |= (1 << PCINT23);

					} else {

						// Clear PCINT23 Bit on PCMSK2
						_PCMSK2 &= ~(1 << PCINT23);
